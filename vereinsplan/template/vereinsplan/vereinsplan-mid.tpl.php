              ...
              <!-- BEGIN KopfMonat -->
                ...
                <table class="Tab_Inhalt2">
                  <tr>
                    ...
                    <td class="Kopf2_U_MN"><!--KLiganame--></td>
                ...
                <!-- BEGIN MonatszeileStat -->
                  <!--MonatsInfoStat-->
                  <tr><td class="sptzeile" colspan="11"><a name="monat<!--MonatNrStat-->"><!--MonatNameStat--></a></td></tr>
                <!-- END MonatszeileStat -->

                  <!--KWzeile-->
                  <!-- BEGIN WochenNr -->
                  <tr><td  class="kwzeile" colspan="11"><a name="kw<!--KWNr-->">&nbsp;</a></td></tr>
                  <!-- END WochenNr -->
                  ...
                  <!-- END BackColor2 -->
                    ...
                    <td class="xinhalt_TH"><!--HeimLogo--><!--Heim-->&nbsp;<!--HeimUrl--></td>
                    <td class="xinhalt_Tr"><!--Trenn--></td>
                    <td class="xinhalt_TG"><!--GastLogo--><!--Gast-->&nbsp;<!--GastUrl--></td>
                    <td class="xinhalt_To"><!--Tore--></td>
                    <td class="xinhalt_MN"><!--Liganame--></td>
