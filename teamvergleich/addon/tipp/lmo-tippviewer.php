  ...
  for ($i=0;$i<$anzspiele;$i++){
    ...
    if ($punktespiel == -1) {
      ...
      if ($tipp_tippmodus == 1) {
         ...
         *
         */
        if ($mnote[$i]!="" || $stats[$i]==1 || $msieg[$i]>0 || $mtipp[$i] > 0) {
		...
		if (file_exists(PATH_TO_ADDONDIR.'/stats/lmo-tippviewer.inc.php')) include(PATH_TO_ADDONDIR.'/stats/lmo-tippviewer.inc.php');
